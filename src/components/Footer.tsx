      ...
      <div className="footer-content">
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              ...
              <a
                href="https://youtube.com/@j_j_clicks"
                target="_blank"
                rel="noopener noreferrer"
                className="footer-social-link"
                aria-label="YouTube"
          ...
          <div className="footer-links">
            ...
            <div className="footer-column">
              ...
              <ul>
                ...
                <li><a href="https://instagram.com/j_j_clicks" target="_blank" rel="noopener noreferrer">Instagram</a></li>
              </ul>
            </div>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            &copy; 2025 JJ Clicks. All rights reserved.
          </p>
          <p className="footer-credit">
            ...
            by <a href="https://mystiq.tech" target="_blank" rel="noopener noreferrer">mystiq.tech</a>
          </p>
        </div>
      </div>
    </footer>
